...
def render_prediction():
    """Fungsi ini men-load bundle (joblib) dan menampilkan UI prediksi.
    Panggil dari app.py: stream_car.render_prediction()
    """
    # Try load bundle; tampilkan pesan jika gagal
    try:
    ...
    # sensible defaults for mapping if missing
    defaults = {
